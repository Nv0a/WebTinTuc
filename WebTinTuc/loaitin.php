<?php
    ...
    $idlt = $_GET['idlt'];
    $p =  isset($_GET['p']) ? (int)$_GET['p'] : 1; // p là trang cần xem
    // Số tin 1 trang => do người lập trình quy định
    $soTin1Trang = 2;
    // Vị trí bắt đầu trong bảng tintuc
    $from = ($p - 1) * $soTin1Trang;
    // Tính tổng số trang => tong so tin / So tin 1 trang và làm tròn
    // Tính tổng số tin
